        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              <div class="title-with-text">
                <div class="title h2 animate-item fadeInUp">Doeltreffende, efficiënte web en mobiele oplossingen gepersonaliseerd voor jouw bedrijf</div>
                <div class="text animate-item fadeInUp delay-1">We weten waar het pijn doet in je niche! We beschikken over een brede scala aan tools om de pijn te verzachten: analyse, branding, website ontwikkeling, app creation en technische ondersteuning.</div>
              </div>
            </div>
          </div>
          <div class="row categories animate-item fadeInUp delay-1">
            ...
            <div class="col-sm-6 col-md-4 category">
              <a href="car-dealers" class="category-entry">
                <span class="category-title">Auto dealers</span>
                <div class="category-img">
                  <div class="category-img-box">
                    <picture>
          ...
          <div class="text-center animate-item fadeInUp">
            <a class="btn btn-primary" href="portfolio">
              <b>Bekijk hier al onze projecten</b>
            </a>
          </div>
        </div>
        <div class="spacer-xl"></div>
          ...
          <div class="row">
            <div class="col-xl-5 offset-xl-7">
              <div class="ml-80 animate-item fadeInUp delay-1">
                <div class="title h5 fw-500 d-none d-xl-block">Vertel ons jouw idee / ideeën en wij bedenken oplossingen.</div>
