      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 1</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="img/seo-img.jpg" src="video/banner-video1.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
          </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 2</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="img/seo-img.jpg" src="video/banner-video2.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
          </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 3</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="img/seo-img.jpg" src="video/banner-video3.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
          </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 4</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="img/seo-img.jpg" src="video/banner-video4.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
          </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">banner gif video</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="img/seo-img.jpg" src="video/banner-video-gif.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
                https://media.giphy.com/media/JoVV55m3KZHdxlpFZ6/giphy-downsized.gif
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
          </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">banner gif video 2</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="img/seo-img.jpg" src="video/banner-video-gif2.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
                https://media.giphy.com/media/JoVV55m3KZHdxlpFZ6/giphy-downsized.gif
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 7</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="img/seo-img.jpg" src="video/banner-video7.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
          </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 8</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="img/seo-img.jpg" src="video/banner-video8.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
          </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 9</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="img/seo-img.jpg" src="video/banner-video9.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
          </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 10</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="img/seo-img.jpg" src="video/banner-video10.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
          </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 11</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="img/seo-img.jpg" src="video/banner-video11.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
          </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 12</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
              ...
              <a href="category-detail.php" class="category-entry">
                ...
                <span class="category-img">
                  <picture>
                    ...
                    <img src="img/category-img-10.png" width="346" height="340" alt="">
                  </picture>
                </span>
              ...
              <a href="category-detail.php" class="category-entry">
                ...
                <span class="category-img">
                  <picture>
                    ...
                    <img src="img/category-img-8.png" width="467" height="352" alt="">
                  </picture>
                </span>
                <div class="review-btn">
                  <i class="review-icon"></i>
              ...
              <a href="category-detail.php" class="category-entry">
                ...
                <span class="category-img">
                  <picture>
                    ...
                    <img src="img/category-img-5.png" width="292" height="410" alt="">
                  </picture>
                </span>
                <div class="review-btn">
                  <i class="review-icon"></i>
              ...
              <a href="category-detail.php" class="category-entry">
                ...
                <span class="category-img">
                  <picture>
                    ...
                    <img src="img/category-img-9.png" width="430" height="392" alt="">
                  </picture>
                </span>
                <div class="review-btn">
                  <i class="review-icon"></i>
              ...
              <a href="category-detail.php" class="category-entry">
                ...
                <span class="category-img">
                  <picture>
                    ...
                    <img src="img/category-img-7.png" width="492" height="339" alt="">
                  </picture>
                </span>
                <div class="review-btn">
                  <i class="review-icon"></i>
              ...
              <a href="category-detail.php" class="category-entry">
                ...
                <span class="category-img">
                  <picture>
                    ...
                    <img src="img/category-img-3.png" width="471" height="503" alt="">
                  </picture>
                </span>
                <div class="review-btn">
                  <i class="review-icon"></i>
          ...
          <div class="row">
            <div class="col-xl-5 offset-xl-1">
              ...
              <div class="simple-page text text-sm animate-item fadeInUp delay-1">
                ...
                <p>Розробка будь-якого web проекту складається з декількох важливих етапів, що йдуть поступово, тому над процесом працює цілий штат фахових спеціалістів серед яких: веб дизайнери, веб програмісти, копірайтери, SEO спеціалісти та маркетолог.</p>
                <h2>Розробка сайтів поділяється на наступні типи:</h2>
                <ul>
                  <li>корпоративні інтернет ресурси;</li>
                  <li>сторінки, що продають товари та послуги, (лендінги);</li>
                  <li>сучасні, багатофункційні інтернет магазини;</li>
                  <li>публічні та корпоративні портали;</li>
                  <li>промо, маркетингові сайти.</li>
                </ul>
                <h2>Створимо сайт Вашої мрії</h2>
