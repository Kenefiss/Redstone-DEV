        ...
        <div class="title-with-text no-align animate-item fadeInUp">
          ...
          <a href="https://clutch.co/profile/redstone?page=1#reviews" target="_blank" rel="nofollow" class="general-rating">
            ...
            <div class="content">
              ...
              <div class="general-review">32 recenzje</div>
            </div>
          </a>
          ...
          <div class="swiper-container" data-options='{"spaceBetween": 15, "slidesPerView": 1, "autoHeight": false, "breakpoints": {"575": {"spaceBetween": 30, "autoHeight": false}}}'>
            ...
            <div class="col-md-4 swiper-slide">
                <div class="review-block">
                  <a class="full-link" href="https://clutch.co/profile/redstone?project_cost=&review_type=&service_provided=&sort_by=rating_DESC#review-2045789" rel="nofollow" target="_blank"></a>
                  <div class="review-info">
                    <div class="review-quote"><img src="img/reviews/review-cl-2.jpg" alt=""></div>
                    <div class="review-title">Ivan Fernandez</div>
                    <div class="review-category">Co-Owner, Carpathian Mint</div>
                  </div>
                  <div class="review-content">
                    ...
                    <div class="review-price-block text">
                      ...
                      <div class="verify-price"><img src="img/price-icon.svg" loading="lazy" alt="price icon">Mniej niż 10,000 $</div>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-4 swiper-slide">
                <div class="review-block">
                  ...
                  <div class="review-content">
                    ...
                    <div class="review-price-block text">
                      <div class="verify-review"><img src="img/verified-icon.svg" loading="lazy" alt="verified icon">Zweryfikowano</div>
                      <div class="verify-price"><img src="img/price-icon.svg" loading="lazy" alt="price icon">Ponad 100,000 $</div>
                    </div>
                  </div>
                </div>
              </div>
