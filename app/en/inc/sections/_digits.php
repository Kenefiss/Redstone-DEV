      ...
      <div class="col-12">
        <div class="title-with-text">
          ...
          <div class="text color-2 animate-item fadeInUp delay-1">
            Tasks with an asterisk are our profile. Solving them, we have repeatedly received awards in United Kingdom and all over the world. The <span>REDSTONE</span> team is always ready for new challenges.
          </div>
        </div>
      </div>
    </div>
    <div class="row counters justify-content-center justify-content-lg-start animate-item fadeInUp delay-2">
      ...
      <div class="col-6 col-lg-4 counter">
        <div class="counter-block">
          ...
          <small class="ml-0">years on the market</small>
        </div>
      </div>
      <div class="col-6 col-lg-4 counter">
        <div class="counter-block">
