...
<head>
  ...
  <title>Website development Lviv :: REDSTONE :: Website development Lviv</title>
  <meta name="description" content="Створення сайтів та розробка сайтів - веб студія REDSTONE. 15 років досвіду, по створенню сайтів, дизайну (UI/UX), копірайту, тестування та SEO.">
</head>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 5</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">Video 6</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">banner gif 3</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num gif">
                <div>16</div>
                <img src="../video/banner-gif3.gif" loading="lazy" alt="">
              </div>
              <div class="sub-title text-center"><span class="d-xl-none">16</span> Років переносимо ваш бізнес online</div>
            </div>
          </div>
      ...
      <div class="section banner main-banner">
        <div class="container full-height">
          <div class="row align-items-lg-center">
            <div class="col-xl-7 order-2 order-xl-1">
              <div class="banner-content">
                <div class="title h1">banner gif video 3</div>
                <a href="#" class="btn btn-primary">
                  <b>НАШІ РОБОТИ</b>
                </a>
                <div class="logo-group">
            ...
            <div class="col-xl-5 order-1 order-xl-2">
              <div class="banner-num">
                <div>16</div>
                <video preload="auto" poster="../img/seo-img.jpg" src="../video/banner-video-gif3.mp4" playsinline loop autoplay muted disablepictureinpicture></video>
      ...
      <div class="section" id="contact">
        ...
        <div class="container">
          <div class="row">
            <div class="col-12">
              <div class="title-with-text">
                <div class="title h2 animate-item fadeInUp">Let's make the world better together!</div>
              </div>
            </div>
          </div>
          <div class="row">
